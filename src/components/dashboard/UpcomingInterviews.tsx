...
export const UpcomingInterviews: React.FC<UpcomingInterviewsProps> = ({ interviews }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900/60 border border-slate-200 dark:border-slate-800/80 rounded-2xl p-6 shadow-soft dark:shadow-soft-dark space-y-4 h-full flex flex-col justify-between">
