  ...
  return (
    <section aria-label="Aktivite Akışı ve Mülakatlar" className="space-y-4 animate-fadeIn">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <article className="lg:col-span-3 bg-white/80 dark:bg-[#162238]/75 backdrop-blur-xl border border-slate-200/80 dark:border-slate-800/70 rounded-3xl p-6 shadow-soft dark:shadow-soft-dark space-y-4 specular-border hover:border-slate-300 dark:hover:border-slate-700/80 transition-all">
          <div className="flex items-center justify-between">
