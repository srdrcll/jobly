...
export const InlineInterviewResultDropdown: React.FC<InlineInterviewResultDropdownProps> = ({
  ...
  return (
    <div className="relative inline-block text-left" ref={containerRef}>
      ...
      {isOpen && (
        <div 
          className="absolute left-0 top-full mt-1.5 w-48 bg-white/95 dark:bg-[#0E1424]/95 backdrop-blur-xl border border-slate-200/90 dark:border-slate-800/90 rounded-2xl shadow-xl z-50 p-1.5 space-y-1 animate-fadeIn specular-border"
