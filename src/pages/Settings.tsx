            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2 pt-3 border-t border-slate-100 dark:border-slate-800/60">
                ...
                <select
                  ...
                  className="w-full max-w-xs px-3 py-2 bg-slate-100 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-xs text-foreground focus:outline-none"
                >
